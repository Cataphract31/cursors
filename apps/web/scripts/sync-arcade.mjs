 ...
 *   node apps/web/scripts/sync-arcade.mjs           copy in, report what moved
 *   node apps/web/scripts/sync-arcade.mjs --check   fail if a copy has drifted
...
if (check) {
  if (drifted.length) {
    ...
    console.error("\n  If the arcade changed:  node apps/web/scripts/sync-arcade.mjs");
